...
public class JSAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    private void initTextChangedListener() {
        textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                updateAutocompleteSuggestions(userInput);
            }
    ...
    private void updateAutocompleteSuggestions(String input) {
        ...
        handler.postDelayed(() -> {
            ...
            String jsCode = buildJsPropertyFetchCode(obj);
    ...
    private String buildJsPropertyFetchCode(String obj) {
        return "(function() { try { return Object.getOwnPropertyNames(" + obj + "); } catch (e) { return []; } })();";
    }
    ...
    private void updateAdapter(List<String> suggestions) {
        handler.post(() -> {
            ...
            if (!suggestions.isEmpty() && !isPopupShowing() && isFocused()) showDropDown();
        });
    }
    ...
    private void runJavaScriptAsync(String jsCode, java.util.function.Consumer<String> callback) {
        CompletableFuture.supplyAsync(() -> evaluateJsSync(jsCode), executor)
                .thenAccept(callback);
    }
