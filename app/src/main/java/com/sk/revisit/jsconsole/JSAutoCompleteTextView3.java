...
public class JSAutoCompleteTextView3 extends AppCompatAutoCompleteTextView {
	...
	public JSAutoCompleteTextView3(Context context) {
		this(context, null);
	}

	public JSAutoCompleteTextView3(Context context, AttributeSet attrs) {
		this(context, attrs, androidx.appcompat.R.attr.autoCompleteTextViewStyle);
	}

	public JSAutoCompleteTextView3(Context context, AttributeSet attrs, int defStyleAttr) {
